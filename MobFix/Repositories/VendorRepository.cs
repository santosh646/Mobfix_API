...
namespace MobFix.Repositories
{
    public class VendorRepository
    {
        ...
        public int InsertVendorRegistrationDetails(Vendor vendor)
        {
            ...
            InsertVendorregistrationInfo += $"INSERT INTO Mobifix_DB.CUST_INFO(FK_CUST_VEND_ADMIN_ID, FIRST_NAME, LAST_NAME, FULL_NAME, NAMEPREFIX,GENDER,CREATED_DATE, CREATED_BY, LASTMODIFIED_DATE, LASTMODIFIED_BY) " +
                 $"Select LAST_INSERT_ID(),'{vendor.FirstName}', '{vendor.LastName}' ,'{vendor.FullName}','{vendor.NamePrefix}','{vendor.Gender}', NOW(), {vendor.AddByUserID}, NOW(), {vendor.ChangedByID};";

            InsertVendorregistrationInfo += $"INSERT INTO Mobifix_DB.CUST_ADDRESS (FK_CUST_INFO_ID, FK_CONTACT_TYPE_ID, ADDR_LINE1, ADDR_LINE2, CITY, STATE, COUNTRY, ZIP_CODE, FK_CONTACT_STATUS_CD, CREATED_DATE, CREATED_BY, LASTMODIFIED_DATE, LASTMODIFIED_BY) " +
            ...
            InsertVendorregistrationInfo += $"INSERT INTO Mobifix_DB.CUST_PHONE(FK_CUST_ADDRESS_ID, FK_CONTACT_TYPE_ID, CONTACT_NUMBER, FK_CONTACT_STATUS_CD, CREATED_DATE, CREATED_BY, LASTMODIFIED_DATE, LASTMODIFIED_BY) " +
                 $"Select LAST_INSERT_ID(),{vendor.CustID}, {vendor.ContactNumber} ,'{vendor.ContactStatus}', NOW(), {vendor.AddByUserID}, NOW(), {vendor.ChangedByID}";
            return mySqlHelper.ExecuteNonQuery(InsertVendorregistrationInfo);
        }
